			...
			<div class="row-fluid">
				...
				<div class="span12">
					...
					<div class="span9 well">
						...
						<form class="form-horizontal" id="swatches_form" enctype="multipart/form-data" method="post" action="<?php site_url('admin/product/add');?>" >
							<fieldset>
								<div id="legend" class="">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input placeholder="Swatch Name" id="name" class="input-large" type="text" name="name" value="Swatch">
										<p class="help-block">
											Name of the Swatch
										</p>
									</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="description" id="description">Swatch</textarea>
