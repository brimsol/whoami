...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets/source/jquery.fancybox.js?v=2.1.4"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/assets/source/jquery.fancybox.css?v=2.1.4" media="screen" />
...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets/source/helpers/jquery.fancybox-media.js?v=1.0.5"></script>
